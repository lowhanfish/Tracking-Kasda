...
const MasterPPH = () => {
    ...
    const viewData = () => {
        setLoadData(true);
        axios.post(url.URL_MASTER_PPH + '/view', {}, {
            headers: {
    ...
    const addData = () => {
        ...
        axios.post(url.URL_MASTER_PPH + post_route, JSON.stringify(formData), {
            headers: {
                "Content-Type": 'application/json',
                "Authorization": `kikensbatara ${token}`
            }
    ...
    const handleDelete = (index, data) => {
        setLoadData(true);
        axios.post(url.URL_MASTER_PPH + "/delete", JSON.stringify(data), {
            headers: {
                "Content-Type": 'application/json',
                "Authorization": `kikensbatara ${token}`
            }
                            ...
                            <table className="tabelku shaddow2" style={{ width: '100%' }}>
                                <thead className="h_thead shaddowText">
                                    <tr>
                                        ...
                                        <th style={{ width: '20%' }} scope="col">Uraian</th>
                                        <th style={{ width: '20%' }} scope="col">Nilai</th>
