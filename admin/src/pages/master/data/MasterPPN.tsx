...
const MasterPPN = () => {
    ...
    const viewData = () => {
        setLoadData(true);
        axios.post(url.URL_MASTER_PPN + '/view', {}, {
            headers: {
    ...
    const addData = () => {
        ...
        axios.post(url.URL_MASTER_PPN + post_route, JSON.stringify(formData), {
            headers: {
                "Content-Type": 'application/json',
                "Authorization": `kikensbatara ${token}`
            }
    ...
    const handleDelete = (index, data) => {
        setLoadData(true);
        axios.post(url.URL_MASTER_PPN + "/delete", JSON.stringify(data), {
            headers: {
                "Content-Type": 'application/json',
                "Authorization": `kikensbatara ${token}`
            }
